...
* リージョンが __東京__ になっていることを確認する
* または上部メニューからプルダウンで __アジアパシフィック(東京)__ のリージョンを選択する
...
4.  インターネットゲートウェイのアタッチを実行する

### ルートテーブルを作成する

1. ルートテーブル画面を開く
2. ルートテーブル作成画面を開く
3. 以下の設定をしてルートテーブルを作成を実行する
